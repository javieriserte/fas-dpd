 ...
 * @version 1.1.3
 */
public class ValidateDegeneratedEnd extends ValidatorSimple {

	/**
	 * Validates that a primer is degenerated in the last position.
	 * 
	 * Devuelve true if the end is degenerated.
	 * 			false otherwise.
	 */
	public boolean validate(Primer p) {
		BaseDeg bd = BaseDeg.newBaseDeg();
		return bd.calculateDegValue(p.getSequence().charAt(p.getLength()-1))>1;
	}
