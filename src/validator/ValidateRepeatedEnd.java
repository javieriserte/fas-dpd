...
/**
 * This class represents the condition that a primer have the same base in the last two position.
 * @author Javier Iserte <jiserte@unq.edu.ar>
 * @version 1.1.2
 */
public class ValidateRepeatedEnd extends ValidatorSimple {
	/**
	 * Validates that a primer is repeated in the last two position.
	 * 
	 * Devuelve true if the end is repeated.
	 * 			false otherwise.
	 */
