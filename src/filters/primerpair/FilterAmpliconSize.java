...
public class FilterAmpliconSize extends FilterPrimerPair{
	...
	/**
	 * verify that two primers in opposite sense produces an aplification product shorter than a maximum value.
	 * The size of amplificacion product is estimated by its position in the alignment. If the alignment has gaps, the real-life prouct will be shorter than estimated value.
	 */
